                ...
                <div class="col-md-5">
                  ...
                  <div class="card" style="margin-bottom: 5px; margin-top: 5px;">
                    ...
                    <div class="card-content" style="padding-top: 1px; padding-bottom: 1px;">
                      ...
                      @foreach($keranjang_belanjaan as $keranjang_belanjaans)
                      <div class="row" id="card-produk-{{ $keranjang_belanjaans->id_keranjang_belanja }}">
                        ...
                        <div class="col-md-2">
                          <b align="right" id="jumlah-produk-{{ $keranjang_belanjaans->id_keranjang_belanja }}">{{ $keranjang_belanjaans->jumlah_produk }}</b>
                        </div>
                        ...
                        <div class="col-md-3">
                          ...
                          <div class="col-md-3">
                            ...
                            <b class="text-right" id="subtotal-produk-{{ $keranjang_belanjaans->id_keranjang_belanja }}" data-subtotal="{{$keranjang_belanjaans->produk->harga_jual * $keranjang_belanjaans->jumlah_produk}}">{{ number_format($keranjang_belanjaans->produk->harga_jual * $keranjang_belanjaans->jumlah_produk,0,',','.') }}</b>
