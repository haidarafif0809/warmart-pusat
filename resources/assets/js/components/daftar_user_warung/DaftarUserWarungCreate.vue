                 ...
                 <div>
                    <form v-on:submit.prevent="saveForm()" class="form-horizontal"> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input class="form-control" required autocomplete="off" placeholder="Password" type="password" v-model="user.password" name="password"  autofocus="">
...
export default {
    ...
    methods: {
        ...
        selected() {
          ...
          .catch(function (resp) {
            alert("Tidak dapat memuat data otoritas");
        });
      },
      alert(pesan) {
          this.$swal({
