...
{
    use AuditableTrait;
    protected $fillable   = ['no_faktur', 'satuan_id', 'id_produk', 'jumlah_produk', 'harga_produk', 'subtotal', 'tax', 'potongan', 'warung_id', 'ppn', 'tax_include', 'satuan_dasar', 'created_at', 'faktur_penerimaan', 'faktur_order', 'suplier_id'];
