...
class LaporanPenjualanProdukController extends Controller
{
    ...
    public function prosesLaporanPenjulanProduk(Request $request)
    {
        $laporan_penjualan = DetailPenjualan::laporanPenjualanProduk($request)->paginate(10);
    ...
    public function subtotalPembelianProduk(Request $request)
    {
        ...
        $sub_total_penjualan = DetailPenjualan::subtotalLaporanPembelianProduk($request)->first();
    ...
    {
        $laporan_pembelian = DetailPenjualan::cariLaporanPembelianProduk($request)->paginate(10);
    ...
    public function downloadExcel(Request $request, $dari_tanggal, $sampai_tanggal, $produk, $suplier)
    {
        ...
        $laporan_pembelian = DetailPenjualan::laporanPembelianProduk($request)->get();
    ...
    public function cetakLaporan(Request $request, $dari_tanggal, $sampai_tanggal, $produk, $suplier)
    {
        ...
        $subtotal_pembelian = DetailPenjualan::subtotalLaporanPembelianProduk($request)->first();
