...
{
	use AuditableTrait;
	protected $fillable   = ['session_id', 'no_faktur_order', 'id_produk', 'jumlah_produk', 'satuan_id', 'satuan_dasar', 'harga_produk', 'subtotal', 'tax', 'potongan', 'status_harga', 'warung_id', 'jumlah_fisik', 'selisih_fisik'];
