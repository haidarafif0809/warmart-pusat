                ...
                <div class="card-content">
                    ...
                    <div class="row" style="margin-bottom: 1px; margin-top: 1px;">
                        ...
                        <div class="col-md-2">
                            <div class="card card-produk" style="margin-bottom: 1px; margin-top: 1px;">
                                <div class="form-group" style="margin-right: 10px; margin-left: 10px;">
                                    <selectize-component v-model="inputTbsPembelian.suplier_order" :settings="placeholder_suplier_order" id="suplier" ref='suplier'>
                                        <option v-for="suplier, index in suplierOrder" v-bind:value="suplier.order">
                            ...
                            <div class="col-md-2">
                                <div class="card card-produk" style="margin-bottom: 1px; margin-top: 1px;">
                                    <div class="form-group" style="margin-right: 10px; margin-left: 10px;">
                                        ...
                                        <selectize-component v-model="inputTbsPembelian.suplier_penerimaan" :settings="placeholder_suplier_penerimaan" id="suplier_penerimaan" ref='suplier_penerimaan'>
                                            <option v-for="suplier, index in suplierPenerimaan" v-bind:value="suplier.penerimaan">
                                        ...
                                        <table class="table table-striped table-hover" v-if="seen">
                                            ...
                                            <tbody v-if="tbs_pembelians.length > 0 && loading == false"  class="data-ada">
                                                <tr v-for="tbs_pembelian, index in tbs_pembelians" >
                                                    ...
                                                    <td align="center">
                                                        <a v-bind:href="'#edit-pembelian/'+id_pembelian" v-bind:id="'edit-' + tbs_pembelian.id_tbs_pembelian" v-bind:class="'hurufBesar satuan-' + tbs_pembelian.id_produk" v-bind:data-satuan="''+tbs_pembelian.satuan_id" v-on:click="editSatuanEntry(tbs_pembelian.id_tbs_pembelian, index,tbs_pembelian.nama_produk,tbs_pembelian.subtotal, tbs_pembelian.id_produk)">{{ tbs_pembelian.nama_satuan }}</a>
                                                    </td>
    ...
    export default {
        data: function () {
            return {
                ...
                placeholder_suplier_order: {
                    placeholder: '--ORDER PEMBELIAN--',
                    sortField: 'text',
                    openOnFocus : true

                },
                placeholder_suplier_penerimaan: {
        ...
        methods: {
            ...
            getSuplierOrder(id_pembelian){
                var app = this;

                axios.get(app.url_edit+'/suplier-order/'+id_pembelian)
                .then(function (resp) {
                    app.suplierOrder = resp.data
                    console.log(resp.data)
                })
                .catch(function (resp) {
                    console.log(resp);
                    alert("Tidak Dapat Memuat Suplier Order");
                });
            },
            getSuplierPenerimaan(id_pembelian){
                var app = this;

                axios.get(app.url_edit+'/suplier-penerimaan/'+id_pembelian)
                .then(function (resp) {
                    app.suplierPenerimaan = resp.data
                    console.log(resp.data)
                })
                .catch(function (resp) {
                    console.log(resp);
            ...
            getResults(page) {
                ...
                .then(function (resp) {
                    ...
                    app.getSuplierOrder(id);
                    app.getSuplierPenerimaan(id);
                    app.dataSuplier(app.$route.params.id);
