                                ...
                                <table class="table table-striped table-hover" v-if="seen">
                                    ...
                                    <tbody v-if="tbs_pembelians.length > 0 && loading == false"  class="data-ada">
                                        <tr v-for="tbs_pembelian, index in tbs_pembelians" >
                                            ...
                                            <td>
                                                <a href="#create-pembelian" v-bind:id="'edit-' + tbs_pembelian.id_tbs_pembelian" v-on:click="editEntryJumlah(tbs_pembelian.id_tbs_pembelian, index,tbs_pembelian.nama_produk,tbs_pembelian.subtotal)"><p align='right'>{{ tbs_pembelian.jumlah_produk_pemisah }}</p></a>
                                            </td>
                                            <td align="center">
                                            ...
                                            <td>
                                                <a href="#create-pembelian" v-bind:id="'edit-' + tbs_pembelian.id_tbs_pembelian" v-on:click="editEntryPotongan(tbs_pembelian.id_tbs_pembelian, index,tbs_pembelian.nama_produk,tbs_pembelian.jumlah_produk,tbs_pembelian.harga_produk,tbs_pembelian.subtotal)">
                                                    <p align='right'>{{ tbs_pembelian.potongan }} | {{ Math.round(tbs_pembelian.potongan_persen,2) }} %</p></a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <p id="table-subtotal" align="right">{{ tbs_pembelian.subtotal_tbs }}</p>
                                            </td>
    ...
    methods: {
        ...
        getResults(page) {
            ...
            .catch((resp) => {
                ...
                app.loading = false;
                app.seen = true;
                app.alertGagal("Tidak Dapat Memuat Pembelian");
            });
        },
        ...
        getSatuan(id_produk){
            ...
            .catch((resp) => {
                console.log('catch getSatuan: ', resp);
                app.alertGagal("Tidak Dapat Memuat Satuan Produk");
            });
        },    
        ...
        dataSuplier() {
            ...
            .catch((resp) => {
                console.log('catch dataSuplier: ', resp);
                app.alertGagal("Tidak Bisa Memuat Suplier");
            });
        },
        ...
        saveFormSupplier() {
            ...
            .then((resp) => {
                app.alertBerhasil('Berhasil Menambahkan Supplier ' + app.tambahSuplier.nama_suplier);
            ...
            .catch((resp) => {
                console.log('catch saveFormSupplier: ', resp);
                app.success = false;
        ...
        saveFormKas() {
            ...
            .then((resp) => {
                app.alertBerhasil('Berhasil Menambahkan Kategori Transaksi ' + app.tambahKas.nama_kas)
        ...
        prosesDelete(id, nama_produk, subtotal_lama){
            ...
            .catch((resp) => {
                ...
                app.loading = false;
                app.alertGagal("Tidak dapat Menghapus Produk "+nama_produk);
            });
        },
        ...
        prosesTambahProdukTbs(id_produk, jumlah_produk, harga_produk, nama_produk, satuan_produk, status_harga) {
            ...
            .then((resp) => {
                ...
                app.alertBerhasil('Berhasil Menambahkan Produk ' + titleCase(nama_produk));
                app.loading = false;
                app.getResults();
            ...
            .catch(function (resp) {
                console.log('catch prosesTambahProdukTbs: ', resp);
                app.loading = false;
                app.alertGagal("Tbs Pembelian tidak dapat ditambahkan");
            });
        },
        editEntryJumlah(id, index, nama_produk, subtotal_lama) {    
            ...
            .then((jumlah_produk) => {
                if (jumlah_produk != "0") { 
                    ...
                    .then((resp) => {
                        app.alertBerhasil('Berhasil Mengubah Jumlah Produk ' + titleCase(nama_produk));
                        app.loading = false;
                        app.getResults();      
                    ...
                    .catch((resp) => {
                        console.log('catch editEntryJumlah: ', resp);
                        app.loading = false;
                        app.alertGagal("Jumlah Produk tidak dapat diedit");
                    });
                } else { 
        ...
        subtmitEditSatuan(id_produk, id_tbs, subtotal_lama) {
            ...
            if (satuan_tbs == satuan_produk[0]) {
                ...
                .catch((resp) => {
                    console.log('catch subtmitEditSatuan: ', resp);                  
                    app.loading = false;
                    app.alertGagal("Tidak Dapat Mengubah Satuan");
                });
            }
        },
        editEntryHarga(id, index, nama_produk, subtotal_lama) {    
            ...
            swal({ 
                ...
                if (harga_produk != "0") { 
                    ...
                    .then((resp) => {
                        app.alertBerhasil("Berhasil Mengubah Harga Produk " + titleCase(nama_produk));
                        app.loading = false;
                        app.getResults();
                        var subtotal = (parseInt(app.inputPembayaranPembelian.subtotal) - parseInt(subtotal_lama)) + parseInt(resp.data.subtotal);
                        app.inputPembayaranPembelian.subtotal = subtotal                       
                    ...
                    .catch((resp) => {
                        console.log('catch editEntryHarga: ', resp);
                        app.loading = false;
                        app.alertGagal("Harga Produk tidak bisa diedit");
                    });
                } else { 
