...
//HTTP TESTING
    ...
    public function testHTTPTambahCustomer() {
        ...
        $this->assertDatabaseHas("users",['name' => 'RindangRamadhan', 'email' => 'rindang@gmail.com', 'alamat' => 'Jl. Kedaton, Bandar Lampung', 'status_konfirmasi' => '0', 'wilayah' => '1', 'no_telp' => '085383550858', 'tipe_user' => '3', 'tgl_lahir' => '1997-01-10']);
    ...
    public function testHTTPUpdateCustomer(){
        ...
        $response2 = $this->get($response->headers->get('location'))->assertSee('Sukses : Berhasil Mengubah Customer "RindangRamadhan Edit"');
