                            ...
                            <div class="collapse" id="logout">
                                <ul class="nav">
                                    <li>
                                        ...
                                        <router-link :to="{name: 'ubahProfilUserWarung'}">
                                            Ubah Profil User
                                        </router-link>
                                        ...
                                        <router-link :to="{name: 'ubahProfilAdmin'}">
                                            Ubah Profil
                                        </router-link>
                                        @endif
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <router-link :to="{name: 'ubahPasswordAdmin'}">
                                            Ubah Password
                                        </router-link>
                                        @else
                                        <router-link :to="{name: 'ubahPasswordUserWarung'}">
                                            Ubah Password
                                        </router-link>
                                        @endif
                                    </li>
...
@if(Laratrust::can('lihat_warung'))
                                    <li>
                                        <router-link :to="{name: 'indexWarung'}">
                                            <span class="sidebar-mini">
                                                W
                                            </span>
                                            <span class="sidebar-normal">
                                    ...
                                    <!--KELOMPOK PRODUK-->
                                    <li>
                                        <router-link :to="{name: 'indexKelompokProduk'}">
                                            <span class="sidebar-mini">
                                                KP
                                            </span>
                                            <span class="sidebar-normal">
