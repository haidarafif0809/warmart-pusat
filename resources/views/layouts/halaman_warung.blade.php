                    ...
                    <div class="row">
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <input class="form-control" id="cari_produk" name="id_warung" type="hidden" value="{{$id}}"/>
                            </div>
                        </div>
                        <div class="col-sm-2">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div aria-labelledby="headingTwo" class="panel-collapse collapse" id="collapseTwo" role="tabpanel">
                            <div class="panel-body">
                                <ul class="buttonColor">
                                    <li>
                                        <a href="{{route('halaman-warung.halaman_warung',$id)}}" style="color:white">
                                            <i class="material-icons">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <ul class="nav nav-tabs buttonColor" data-tabs="tabs">
                            <li>
                                <a href="{{route('halaman-warung.halaman_warung',$id)}}">
                                    <i class="material-icons">
                                        format_align_justify
                                    </i>
                                    Semua Kategori
