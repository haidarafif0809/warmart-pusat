...
class CreateTbsReturPenjualansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbs_retur_penjualans', function (Blueprint $table) {
            $table->increments('id_tbs_retur_penjualan');
    ...
    {
        Schema::dropIfExists('tbs_retur_penjualans');
    }
}
