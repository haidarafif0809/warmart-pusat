...
public function downloadExcel(Request $request, $dari_tanggal, $sampai_tanggal, $suplier, $laporan)
{
    ...
    Excel::create('Laporan Hutang Beredar', function ($excel) use ($request, $data_supplier_hutang,$jumlah_masuk,$jumlah_keluar,$sisa_hutang,$laporan) {
            // Set property
        $excel->sheet('Laporan Hutang Beredar', function ($sheet) use ($request, $data_supplier_hutang,$jumlah_masuk,$jumlah_keluar,$sisa_hutang,$laporan) {
            $row = 1;
            if ($laporan == 1) {
                $sheet->row($row, [
...
public function cetakLaporan(Request $request, $dari_tanggal, $sampai_tanggal, $suplier, $laporan)
{
        //SETTING APLIKASI
