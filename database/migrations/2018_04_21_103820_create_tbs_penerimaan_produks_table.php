...
class CreateTbsPenerimaanProduksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbs_penerimaan_produks', function (Blueprint $table) {
            $table->increments('id_tbs_penerimaan_produk');
            $table->string('session_id');
            $table->string('no_faktur_order')->nullable();
    ...
    {
        Schema::dropIfExists('tbs_penerimaan_produks');
    }
}
