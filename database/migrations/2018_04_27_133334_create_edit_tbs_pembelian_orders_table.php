...
class CreateEditTbsPembelianOrdersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('edit_tbs_pembelian_orders', function (Blueprint $table) {
            $table->increments('id_edit_tbs_pembelian_order');
    ...
    {
        Schema::dropIfExists('edit_tbs_pembelian_orders');
    }
}
