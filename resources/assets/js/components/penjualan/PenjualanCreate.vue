        ...
        <div class="col-md-12">
            ...
            <div class="card" style="margin-bottom: 1px; margin-top: 1px;">
                ...
                <div class="col-md-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group" style="margin-right: 10px; margin-left: 10px; margin-bottom: 1px; margin-top: 1px;">
                                        ...
                                        <datepicker :input-class="'form-control'" placeholder="Jatuh Tempo" v-model="penjualan.jatuh_tempo" v-shortkey.focus="['f6']" ></datepicker>
                    ...
                    <div class="card card-pembayaran"  style="margin-bottom: 3px; margin-top: 3px;">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group" style="margin-right: 10px; margin-left: 10px; margin-bottom: 1px; margin-top: 1px;">
                        ...
                        <div class="row">                        
                            <div class="col-md-6">
                                <div class="form-group" style="margin-right: 10px; margin-left: 10px; margin-bottom: 1px; margin-top: 1px;">
                                   ...
                                   <money readonly="" id="kembalian" name="kembalian" placeholder="Kembalian"  v-model="penjualan.kembalian" v-bind="separator" ></money> 
                               </div>
                           </div>
                           ...
                           <div class="col-md-6">
                               <div class="form-group" style="margin-right: 10px; margin-left: 10px; margin-bottom: 1px; margin-top: 1px;">
                                   ...
                                   <money readonly="" id="kredit" name="kredit" placeholder="Kredit"  v-model="penjualan.kredit" v-bind="separator" ></money> 
                               </div>
                           </div>
                       </div>
                   </div>
               ...
               <div class="card" style="margin-bottom: 3px; margin-top: 3px;">
                ...
                <div class="form-group" style="margin-right: 10px; margin-left: 10px;">
                    <selectize-component v-model="penjualan.pelanggan" :settings="placeholder_pelanggan" id="pelanggan" ref='pelanggan' v-shortkey.focus="['f2']" > 
            ...
            <div class="form-group" style="margin-right: 10px; margin-left: 10px;">
                ...
                <span v-if="selesaiPembayaran == false">
                    <button type="button" class="btn btn-success" id="bayar" v-on:click="bayar" ><i class="material-icons">send</i>Selesai</button>
                </span>
                <span v-else>
    ...
    data: function () {
        return {
            ...
            placeholder_pelanggan: {
                placeholder: '--PILIH PELANGGAN (F2)--'
            },
            placeholder_kas: {
...
,getDataPenjualan(){
    ...
    var app = this;
    axios.get(app.url+'/cek-data-tbs-penjualan').then(function (resp) {
    ...
    .catch(function (resp) {
        ...
        console.log(resp);
        alert("Tidak Bisa Memuat Penjualan");
    })
