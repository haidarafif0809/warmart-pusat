<div class="form-group{{ $errors->has('kas') ? ' has-error' : '' }}">
	...
	<div class="col-md-4">
		{!! Form::select('kas', $data_kas, null, ['class'=>'js-selectize-reguler', 'placeholder' => ' Kas','id'=>'kas']) !!}
...
<div class="form-group{{ $errors->has('kategori') ? ' has-error' : '' }}">
	...
	<div class="col-md-4">
		{!! Form::select('kategori', $data_kategori_transaksi, null, ['class'=>'js-selectize-reguler', 'placeholder' => ' Kategori Transaksi','id'=>'kategori_transaksi']) !!}
