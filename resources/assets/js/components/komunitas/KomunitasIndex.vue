		...
		<div class="col-md-12">
			...
			<div class="card">
				...
				<div class="card-content">
						...
						<table class="table table-striped table-hover ">
							...
							<tbody v-if="komunitas.length"  class="data-ada">
								<tr v-for="komunitas, index in komunitas" >
									...
									<td v-if="komunitas.konfirmasi_admin == 0"> <a href="#" class="btn btn-xs btn-primary" v-bind:id="'konfirmasi-ya-' + komunitas.id" v-on:click="ConfirmEntry(komunitas.id, index,komunitas.nama_komunitas)">Iya</a> </td>

									<td v-else><a href="#" class="btn btn-xs btn-danger" v-bind:id="'konfirmasi-no-' + komunitas.id" v-on:click="NoConfirmEntry(komunitas.id, index,komunitas.nama_komunitas)">Tidak</a></td>
					...
					<div align="right"><pagination :data="komunitasData" v-on:pagination-change-page="getResults" :limit="4"></pagination></div>
