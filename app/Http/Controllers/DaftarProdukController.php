        ...
        <div class="col-md-3 col-sm-6 col-xs-6">
          ...
          <div class="card-content">
            <div class="footer">     
              ...
              if ($agent->isMobile()) {
                $daftar_produk .= '<a href="'.url("/keranjang-belanja") .'" class="btn btn-danger btn-round btn-sm" rel="tooltip" title="Tambah Ke Keranjang Belanja" id="btnBeliSekarang"><b> Beli </b><i class="material-icons">keyboard_arrow_right</i></a>';
              }
              else{
