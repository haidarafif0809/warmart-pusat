...
<body>
	...
	<div class="container">
		<div class="row"><!--row1-->
			...
			<div class="col-sm-8">
				<center> <h4> <b> {{strtoupper($retur_pembelian->name)}} </b> </h4> 
					<p> {{$retur_pembelian->alamat}}<br>
						No.Telp : {{$retur_pembelian->no_telpon}} 
					</p> 
				</center>
		...
		<div class="row">
			<div class="col-sm-9">				
				<table>
					<tbody>
						<tr><td width="25%">No Transaksi</td> <td> :</td> <td>{{$retur_pembelian->no_faktur_retur}} </tr>
					</tbody>
				</table>
			</div>
			...
			<div class="col-sm-3">
				<table>
					<tbody>
						<tr><td width="25%"> Waktu</td> <td> :&nbsp;&nbsp;</td> <td>{{tanggal($retur_pembelian->created_at)}} </td></tr> 
						<tr><td width="25%"> Supplier</td> <td> :&nbsp;&nbsp;</td> <td>{{$retur_pembelian->nama_suplier}}</td></tr> 
		...
		<table class="table table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td class="text-right">{{ pemisahTitik($detail_returs->jumlah_produk) }}</td>
					...
					<td class="text-right">{{ pemisahTitik($detail_returs->tax) }}</td>
			...
			<div class="col-sm-3">
				<table>
					<tbody>
						...
						<tr><td  width="50%">Diskon Faktur</td> <td> :&nbsp;</td> <td class="text-right"> {{ pemisahTitik($retur_pembelian->potongan) }}  </td></tr>
						<tr><td  width="50%">Potong Hutang</td> <td> :&nbsp;</td> <td class="text-right"> {{ pemisahTitik($retur_pembelian->potong_hutang) }}  </td></tr>
						<tr><td  width="50%">Total Akhir</td> <td> :&nbsp;</td> <td class="text-right"> {{ pemisahTitik($retur_pembelian->total) }}  </td></tr>
					</tbody>
				</table>
			</div>
		</div>
