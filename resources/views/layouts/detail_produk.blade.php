                    ...
                    <div class="main main-raised main-product">
                        <div class="row page-1">
                            ...
                            <div class="row text-center">
                                @if ($cek_produk == 0)
                                <a class="btn btn-round" disabled="" rel="tooltip" style="background-color: #01573e" title="Stok Tidak Ada">
                                    Beli Sekarang
                                    <i class="material-icons">
                                        shopping_cart
                                    </i>
                                ...
                                @else
                                <a class="btn btn-round" href="{{ url('/keranjang-belanja/tambah-produk-keranjang-belanja/'.$barang->id.'') }}" id="btnBeliSekarang" rel="tooltip" style="background-color: #01573e" title="Tambah Ke Keranjang Belanja">
                                    Beli Sekarang
                                    <i class="material-icons">
                                        shopping_cart
                                    </i>
