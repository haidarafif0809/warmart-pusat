...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12"><h4><b><center> LAPORAN BUCKET SIZE ONLINE </center></b></h4><hr style="margin: 0px 0px"></div>
			<div class="col-md-9">
				<table>
					<tbody>
			...
			<div class="col-md-12">
				...
				<table class="table table-bordered">
					...
					<tbody>
						...
						<?php $total_faktur_kelipatan = App\Penjualan::countFaktur($request)->whereBetween('total', array($satu, $kelipatan))->first()->id_pesanan;?>
						<tr>
