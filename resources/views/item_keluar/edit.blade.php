...
<div class="modal" id="modal_selesai" role="dialog" data-backdrop="">
    ...
    <!-- Modal content-->
	    <div class="modal-content">
	        ...
	        {!! Form::open(['url' => route('item-keluar.proses_edit_item_keluar',$item_keluar->id),'method' => 'post', 'class'=>'form-horizontal']) !!}
	...
	<div class="col-md-12">
		...
		<div class="card">
			...
			<div class="card-content">
				<h4 class="card-title">Edit Item Keluar : <b>{{$item_keluar->no_faktur}}</b> </h4>
					<div class="row">

					<!--COL MD 8-->
						<div class="col-md-8">
							{!! Form::open(['url' => route('item-keluar.proses_tambah_edit_tbs_item_keluar', $item_keluar->id),'method' => 'post', 'class'=>'form-inline','id' => 'form-produk']) !!}
					          	<div class="col-md-4"><br>
					          		<div class="{{ $errors->has('id_produk') ? ' has-error' : '' }}">
					          			{!! Form::select('id_produk', []+App\Barang::where('status_aktif','1')->select([DB::raw('CONCAT(kode_barang, " - ", nama_barang) AS data_produk'),'id'])->pluck('data_produk','id')->all(), null, ['class'=>' js-selectize-reguler', 'placeholder' => '--PILIH PRODUK--', 'id'=>'pilih_produk']) !!}
					...
					<!--/COL MD 8-->
						...
						<div class="col-md-3">
					 		{!! Form::open(['url' => route('item-keluar.proses_hapus_semua_edit_tbs_item_keluar',$item_keluar->id),'method' => 'post', 'class' => 'form-group js-confirm', 'data-confirm' => 'Apakah Anda Ingin Membatalkan Item keluar ?']) !!}
						 	<!--- TOMBOL SELESAI -->
							 	<div class="col-md-4">
