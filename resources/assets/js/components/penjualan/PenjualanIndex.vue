										...
										<td >
											<div class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-left">
													...
													<li>
														<a href="#penjualan"  v-bind:id="'delete-' + penjualan.id" v-on:click="deleteEntry(penjualan.id, index,penjualan.id,penjualan.subtotal)" v-if="otoritas.hapus_penjualan == 1">Delete
														</a>
													</li>
													<li>
	...
	export default {
		data: function () {
			return {
				...
				urlCetak : window.location.origin+(window.location.pathname).replace("dashboard", "penjualan/cetak-laporan-periode"),
				pencarian: '',
				loading: true,
				seen : false,  
				pencarianOnline: '',
