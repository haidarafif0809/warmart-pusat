		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-md-3 col-xs-3">
						<h5>Disc(Rp)</h5>
						{!! Form::number('potongan_faktur', '', ['class'=>'form-control','autocomplete'=>'off', 'id' =>'potongan_faktur','style'=>'height: 40px; width:90%; font-size:20px;']) !!}
				...
				<span >
					{!! Form::text('suplier_id', null, ['class'=>'form-control','autocomplete'=>'off', 'id'=>'suplier_id']) !!}

					@if($kas_default->count() == 0)
					{!! Form::text('id_cara_bayar', null, ['class'=>'form-control','autocomplete'=>'off', 'id'=>'id_cara_bayar']) !!}
					@else
					{!! Form::text('id_cara_bayar', $kas_default->first()->id, ['class'=>'form-control','autocomplete'=>'off', 'id'=>'id_cara_bayar']) !!}
					@endif
					{!! Form::text('status_pembelian', 'Hutang', ['class'=>'form-control','autocomplete'=>'off', 'id'=>'status_pembelian']) !!}
					{!! Form::text('ppn', null, ['class'=>'form-control','autocomplete'=>'off', 'id'=>'ppn']) !!}
					{!! Form::text('potongan', null, ['class'=>'form-control','autocomplete'=>'off', 'id'=>'potongan']) !!}
				</span>
			</div>
