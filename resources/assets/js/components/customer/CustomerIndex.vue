      ...
      <div class="card">
        <div class="card-header card-header-icon" data-background-color="purple">
         ...
         <div class="card-content">
          ...
          <div class="toolbar">
            <p> <router-link :to="{name: 'createCustomer'}" class="btn btn-primary"><i class="material-icons">add</i> Tambah Customer</router-link></p>
          </div>
              ...
              <tbody v-if="customers.length > 0 && loading== false" class="data-ada">
                <tr v-for="customer, index in customers">
                  ...
                  <td> 
                    ...
                    <router-link :to="{name: 'editCustomer', params: {id: customer.id}}" class="btn btn-xs btn-default" v-bind:id="'edit-' + customer.id" >
                      Edit 
                    </router-link>
                    <a href="#" class="btn btn-xs btn-danger" v-bind:id="'delete-' + customer.id" v-on:click="deleteEntry(customer.id, index,customer.name)"> Delete
                    </a>
                  </td>
                </tr>
              </tbody>
